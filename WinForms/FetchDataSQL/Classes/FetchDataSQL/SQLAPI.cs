...
namespace FetchDataSQL.Classes.FetchDataSQL
{
    /// <summary>
    ...
    public static class SQLAPI
    {
        ...
        {
            using (var requestMessage = new HttpRequestMessage(HttpMethod.Post, SQLForm.APIURL + "/FetchData/SQL"))
            {
                requestMessage.Headers.TryAddWithoutValidation("X-API-Key", SQLForm.APIKEY);
